const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Or try the cloud version of Platform with free quote',
  },
  overview: {
    title: 'Overview',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see Platform\'s <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Install Platform Chatbot Chrome Extension',
        copied: 'Copied',
        copy: 'Copy',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          name: 'Fork the client code, moPlatform it and deploy to Vercel (recommended)',
          step1: 'Fork the client code and moPlatform it',
          step1Tip: 'Click here to fork the source code into your GitHub account and moPlatform the code',
          step1Operation: 'Platform-WebClient',
