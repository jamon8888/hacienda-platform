const translation = {
  ...
  welcome: '👋 Welcome to Platform, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Platform Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Platform',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Platform and we will send you a password reset email.',
