const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Platform account',
    langGeniusAccountTip: 'Your Platform account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Platform to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Platform allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Platform\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Platform {{version}} is now available.',
    latestAvailable: 'Platform {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
  ...
  fileUploader: {
    uploadFromComputer: 'Uploader les documents',
    pasteFileLink: 'Lien vers le document',
