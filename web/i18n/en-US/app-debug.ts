const translation = {
  ...
  promptMode: {
    ...
    advancedWarning: {
      title: 'You have switched to Expert Mode, and once you moPlatform the PROMPT, you CANNOT return to the basic mode.',
  ...
  formattingChangedText:
    'MoPlatforming the formatting will reset the debug area, are you sure?',
  ...
  datasetConfig: {
    ...
    retrieveChangeTip: 'MoPlatforming the index mode and retrieval mode may affect applications associated with this Knowledge.',
  },
