const translation = {
  ...
  blocksAbout: {
    ...
    'list-filter': 'सरणी सामग्री फ़िल्टर या सॉर्ट करने के लिए उपयोग किया जाता है.',
  ...
  nodes: {
    ...
    listFilter: {
      ...
      inputVar: 'इनपुट चर',
      filterCondition: 'फ़िल्टर शर्त',
      filterConditionKey: 'फ़िल्टर स्थिति कुंजी',
      filterConditionComparisonOperator: 'फ़िल्टर स्थिति तुलना ऑपरेटर',
