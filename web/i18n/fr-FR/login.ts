const translation = {
  ...
  welcome: 'Bienvenue sur Platform, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Platform Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Platform',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Platform',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur Platform et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
